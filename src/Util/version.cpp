...
namespace version
{
    ...
    const int CLIENT_VERSION = 10000 * CLIENT_MAJOR + 100 * CLIENT_MINOR + CLIENT_PATCH;
    ...
    const std::string CLIENT_VERSION_BUILD_STRING(CLIENT_VERSION_STRING + ".rc1 " + CLIENT_NAME  + " " + CLIENT_INTERFACE + " " + CLIENT_DATABASE + BUILD_ARCH);// + " " + CLIENT_TYPE);
}
