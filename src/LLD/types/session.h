...
namespace LLD
{
    ...
    *
    **/
    class SessionDB : public Templates::StaticDatabase<BinaryHashMap, BinaryLRU, Config::Hashmap>
    {
    public:

        /** The Database Constructor. To determine file location and the Bytes per Record. **/
        SessionDB(const Config::Static& sector, const Config::Hashmap& keychain);
