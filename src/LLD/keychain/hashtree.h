    ...
    public:
        ...
        void Initialize()
        {
            ...
            if(filesystem::create_directories(strBaseLocation))
                debug::log(0, 0, 0, FUNCTION "Generated Path %s\n", __PRETTY_FUNCTION__, strBaseLocation.c_str());
            ...
            if(!filesystem::exists(index))
            {
                ...
                debug::log(0, 0, 0, FUNCTION "Generated Disk Index of %u bytes\n", __PRETTY_FUNCTION__, vSpace.size());
            }
            ...
            else
            {
                ...
                debug::log(0, 0, 0, FUNCTION "Loaded Disk Index of %u bytes and %u keys\n", __PRETTY_FUNCTION__, vIndex.size(), nTotalKeys);
            }
            ...
            if(!filesystem::exists(file))
            {
                ...
                debug::log(0, 0, 0, FUNCTION "Generated Disk Hash Map %u of %u bytes\n", __PRETTY_FUNCTION__, 0u, vSpace.size());
            }
        ...
        void CacheWriter()
        {
            while(!fShutdown)
            {
                ...
                //debug::log(0, 0, 0, FUNCTION " Flushed %u Index Bytes to Disk\n", __PRETTY_FUNCTION__, vDisk.size());
