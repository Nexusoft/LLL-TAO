...
namespace LLD
{
    ...
    bool SessionDB::PushRegisterTx(const uint256_t& hashRegister, const uint512_t& hashTx)
    {
        /* Get our current sequence number. */
        uint32_t nOwnerSequence = 0;
    ...
    bool SessionDB::EraseRegisterTx(const uint256_t& hashRegister)
    {
        /* Get our current sequence number. */
        uint32_t nOwnerSequence = 0;
    ...
    bool SessionDB::LastRegisterTx(const uint256_t& hashRegister, uint512_t &hashTx)
    {
        /* Get our current sequence number. */
        uint32_t nOwnerSequence = 0;
