...
namespace LLC
{
     ...
     *
     **/
	__attribute__((pure)) inline uint32_t SK32(const std::vector<uint8_t> vch)
	{
		uint32_t hashSkein;
	...
	__attribute__((pure)) inline uint32_t SK32(const T1 pbegin, const T1 pend)
	{
		uint32_t hashSkein;
		Skein_256_Ctxt_t ctxSkein;
		Skein_256_Init  (&ctxSkein, 32);
     ...
     **/
	template<typename T1>
	__attribute__((pure)) inline uint64_t SK64(const T1 pbegin, const T1 pend)
	{
     ...
     *
     **/
	__attribute__((pure)) inline uint64_t SK64(const std::vector<uint8_t>& vch)
	{
		/* Check the cache for this data */
		uint64_t hashKeccak = 0;
     ...
     *
     **/
	__attribute__((pure)) inline uint256_t SK256(const std::vector<uint8_t>& vch)
	{
		/* Check the cache for this data */
     ...
     **/
	template<typename T1>
	__attribute__((pure)) inline uint256_t SK256(const T1 pbegin, const T1 pend)
	{
		/* Copy the data into a vector of bytes so we can cache the hashed value */
		std::vector<uint8_t> vData(pbegin, pend);
	...
	__attribute__((pure)) inline uint256_t SK256(const std::string& str)
	{
     ...
     *
     **/
    __attribute__((pure)) inline uint512_t SK512(const std::vector<uint8_t>& vch)
	{
		/* Check the cache for this data */
     ...
     **/
	template<typename T1>
	__attribute__((pure)) inline uint512_t SK512(const std::vector<uint8_t>& vch, const T1 pbegin, const T1 pend)
	{
		uint512_t hashSkein;
		Skein_512_Ctxt_t ctxSkein;
		Skein_512_Init(&ctxSkein, 512);
     ...
     **/
	template<typename T1>
	__attribute__((pure)) inline uint512_t SK512(const T1 pbegin, const T1 pend)
	{
		/* Copy the data into a vector of bytes so we can cache the hashed value */
		std::vector<uint8_t> vData(pbegin, pend);
	...
	__attribute__((pure)) inline uint512_t SK512(const T1 p1begin, const T1 p1end,
     ...
     **/
	template<typename T1>
	__attribute__((pure)) inline uint576_t SK576(const T1 pbegin, const T1 pend)
	{
		uint576_t hashSkein;
     ...
     **/
	template<typename T1>
	__attribute__((pure)) inline uint1024_t SK1024(const T1 pbegin, const T1 pend)
	{
		/* Copy the data into a vector of bytes so we can cache the hashed value */
		std::vector<uint8_t> vData(pbegin, pend);
