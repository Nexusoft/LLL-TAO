    ...
    public:
        ...
        */
        ...
        bool IsValid()
        {
            ...
            {
                debug::error("Message Packet (Invalid Packet Header");
                return false;
            }
            ...
            {
                debug::error("Message Packet (%s, %u bytes) : Message too Large", MESSAGE, LENGTH);
                return false;
            }
            ...
            {
                debug::error("Message Packet (%s, %u bytes) : CHECKSUM MISMATCH nChecksum=%u hdr.nChecksum=%u",
