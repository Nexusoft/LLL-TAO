...
namespace LLP
{
    ...
    /* Constructor */
    MessageConnection::MessageConnection(const Socket &SOCKET_IN, DDOS_Filter* DDOS_IN, bool fDDOSIn, bool fOutgoing)
    : BaseConnection<MessagePacket>(SOCKET_IN, DDOS_IN, fDDOSIn, fOutgoing)
    {
    }


    /* Constructor */
    MessageConnection::MessageConnection(DDOS_Filter* DDOS_IN, bool fDDOSIn, bool fOutgoing)
   : BaseConnection<MessagePacket>(DDOS_IN, fDDOSIn, fOutgoing)
   {
   }
    ...
    void MessageConnection::ReadPacket()
    {
