...
namespace LLP
{
                    ...
                    switch(nType)
                    {
                        ...
                        case TYPES::NOTIFICATION:
                        {
                            ...
                            if(nType == TYPES::SIGCHAIN)
                            {
                                ...
                                uint256_t hashLogin = TAO::API::Commands::Find<TAO::API::Users>()->GetGenesis(0);
    ...
    DataStream TritiumNode::GetAuth(bool fAuth)
    {
        ...
        if(TAO::API::Commands::Find<TAO::API::Users>()->LoggedIn() && TAO::API::GetSessionManager().Get(0, false).GetNetworkKey() != 0)
        {
            /* Get the Session */
