...
namespace TAO
{
    ...
    namespace API
    {
        ...
        encoding::json Users::ProcessNotifications(const encoding::json& jParams, const bool fHelp)
        {
            ...
            Session& session = Commands::Instance<Users>()->GetSession(jParams, true, fLogActivity);
            ...
            SecureString strPIN = Commands::Instance<Users>()->GetPin(jParams, TAO::Ledger::PinUnlock::NOTIFICATIONS);
