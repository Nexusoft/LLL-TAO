    ...
    namespace API
    {
        ...
        *  for the method being called */
        json::json RPC::SanitizeParams(const std::string& strMethod, const json::json& jsonParams)
        {
            ...
            //
            if (strMethod == "setgenerate"            && n > 0) encoding::StringValueTo<bool>(jsonSanitizedParams[0]);
            if (strMethod == "dumprichlist"           && n > 0) encoding::StringValueTo<int>(jsonSanitizedParams[0]);
            if (strMethod == "setgenerate"            && n > 1) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[1]);
            if (strMethod == "sendtoaddress"          && n > 1) encoding::StringValueTo<double>(jsonSanitizedParams[1]);
            if (strMethod == "settxfee"               && n > 0) encoding::StringValueTo<double>(jsonSanitizedParams[0]);
            if (strMethod == "getreceivedbyaddress"   && n > 1) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[1]);
            if (strMethod == "getreceivedbyaccount"   && n > 1) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[1]);
            if (strMethod == "listreceivedbyaddress"  && n > 0) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[0]);
            if (strMethod == "listreceivedbyaddress"  && n > 1) encoding::StringValueTo<bool>(jsonSanitizedParams[1]);
            if (strMethod == "listreceivedbyaccount"  && n > 0) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[0]);
            if (strMethod == "listreceivedbyaccount"  && n > 1) encoding::StringValueTo<bool>(jsonSanitizedParams[1]);
            if (strMethod == "getbalance"             && n > 1) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[1]);
            if (strMethod == "getblockhash"           && n > 0) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[0]);
            if (strMethod == "getblock"               && n > 1) encoding::StringValueTo<bool>(jsonSanitizedParams[1]);
            if (strMethod == "move"                   && n > 2) encoding::StringValueTo<double>(jsonSanitizedParams[2]);
            if (strMethod == "move"                   && n > 3) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[3]);
            if (strMethod == "sendfrom"               && n > 2) encoding::StringValueTo<double>(jsonSanitizedParams[2]);
            if (strMethod == "sendfrom"               && n > 3) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[3]);
            if (strMethod == "listtransactions"       && n > 1) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[1]);
            if (strMethod == "listtransactions"       && n > 2) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[2]);
            if (strMethod == "totaltransactions"      && n > 0) encoding::StringValueTo<bool>(jsonSanitizedParams[0]);
            if (strMethod == "gettransactions"        && n > 1) encoding::StringValueTo<int>(jsonSanitizedParams[1]);
            if (strMethod == "gettransactions"        && n > 2) encoding::StringValueTo<bool>(jsonSanitizedParams[2]);
            if (strMethod == "listaddresses"          && n > 0) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[0]);
            if (strMethod == "listaccounts"           && n > 0) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[0]);
            if (strMethod == "listunspent"            && n > 0) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[0]);
            if (strMethod == "listunspent"            && n > 1) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[1]);
            if (strMethod == "walletpassphrase"       && n > 1) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[1]);
            if (strMethod == "walletpassphrase"       && n > 2) encoding::StringValueTo<bool>(jsonSanitizedParams[2]);
            if (strMethod == "listsinceblock"         && n > 1) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[1]);
            if (strMethod == "sendmany"                && n > 2) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[2]);
            if (strMethod == "addmultisigaddress"      && n > 0) encoding::StringValueTo<uint64_t>(jsonSanitizedParams[0]);
