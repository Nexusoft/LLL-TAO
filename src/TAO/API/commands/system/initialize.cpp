...
namespace TAO
{
    ...
    namespace API
    {
        ...
        void System::Initialize()
        {
            ...
            mapFunctions["validate/pin"]            = Function(std::bind(&System::VerifyPin,             this, std::placeholders::_1, std::placeholders::_2));
            mapFunctions["validate/tokenizedasset"] = Function(std::bind(&System::VerifyTokenizedAsset,  this, std::placeholders::_1, std::placeholders::_2));
        }
