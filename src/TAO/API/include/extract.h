...
namespace TAO::API
{
     ...
     *
     **/
    TAO::Register::Address ExtractAddress(const encoding::json& jParams, const std::string& strSuffix = "", const std::string& strDefault = "") __attribute__((const));
     ...
     *
     **/
    TAO::Register::Address ExtractToken(const encoding::json& jParams) __attribute__((const));;
     ...
     *
     **/
    TAO::Register::Address ExtractAddress(const std::string& strAddress, const encoding::json& jParams) __attribute__((const));
     ...
     *
     **/
    bool ExtractLegacy(const encoding::json& jParams, Legacy::NexusAddress &addrLegacy, const std::string& strSuffix = "") __attribute__((const));
     ...
     *
     **/
    bool ExtractLegacy(const std::string& strAddress, Legacy::NexusAddress &addrLegacy) __attribute__((const));
     ...
     *
     **/
    std::pair<uint256_t, uint256_t> ExtractMarket(const encoding::json& jParams) __attribute__((const));
     ...
     *
     **/
    uint256_t ExtractGenesis(const encoding::json& jParams) __attribute__((const));
     ...
     *
     **/
    uint256_t ExtractRecipient(const encoding::json& jParams) __attribute__((const));
     ...
     *
     **/
    uint512_t ExtractHash(const encoding::json& jParams) __attribute__((const));
     ...
     *
     **/
    uint64_t ExtractAmount(const encoding::json& jParams, const uint64_t nFigures, const std::string& strKey = "") __attribute__((const));
     ...
     *
     **/
    precision_t ExtractPrecision(const encoding::json& jParams, const uint8_t nDigits, const std::string& strKey = "") __attribute__((const));
     ...
     *
     **/
    std::string ExtractFieldname(const encoding::json& jParams) __attribute__((const));
     ...
     *
     **/
    std::string ExtractFormat(const encoding::json& jParams, const std::string& strDefault, const std::string& strAllowed = "json") __attribute__((const));
     ...
     *
     **/
    uint8_t ExtractScheme(const encoding::json& jParams, const std::string& strAllowed = "falcon, brainpool") __attribute__((const));
     ...
     *
     **/
    std::string ExtractType(const encoding::json& jParams) __attribute__((const));
     ...
     *
     **/
    SecureString ExtractPIN(const encoding::json& jParams, const std::string& strPrefix = "") __attribute__((const));
     ...
     *
     **/
    std::set<std::string> ExtractTypes(const encoding::json& jParams) __attribute__((const));
     ...
     *
     **/
    uint32_t ExtractVerbose(const encoding::json& jParams, const uint32_t nMinimum = 1) __attribute__((const));
     ...
     *
     **/
    void ExtractList(const encoding::json& jParams, uint32_t &nLimit, uint32_t &nOffset) __attribute__((const));
     ...
     *
     **/
    void ExtractList(const encoding::json& jParams, std::string &strOrder, uint32_t &nLimit, uint32_t &nOffset) __attribute__((const));
     ...
     *
     **/
    std::string ExtractOrder(const encoding::json& jParams, const bool fThrow = false) __attribute__((const));
     ...
     *
     **/
    bool ExtractBoolean(const encoding::json& jParams, const std::string& strKey, const bool fDefault = false) __attribute__((const));
     ...
     *
     **/
    uint256_t ExtractHash(const encoding::json& jParams, const std::string& strKey, const uint256_t& hashDefault = ~uint256_t(0)) __attribute__((const));
     ...
     *
     **/
    std::string ExtractString(const encoding::json& jParams, const std::string& strKey) __attribute__((const));
    ...
    double ExtractDouble(const encoding::json& jParams, const std::string& strKey,
                         ...
                         const double dLimit = std::numeric_limits<double>::max()) __attribute__((const));
}
