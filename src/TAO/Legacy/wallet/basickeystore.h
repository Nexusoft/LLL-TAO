...
namespace Legacy 
{
    ...
    namespace Wallet
    {
        ...
        public:
             ...
             *
             **/
            virtual bool AddCScript(const Legacy::Types::CScript& redeemScript) override;
             ...
             *
             **/
            virtual bool GetCScript(const uint256_t &hash, Legacy::Types::CScript& redeemScriptOut) const override;
