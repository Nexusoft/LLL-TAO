...
namespace Legacy
{
    ...
    namespace Wallet
    {
        ...
        public:
             ...
             *
             **/
            CWalletTx(const CWallet& walletIn, const Legacy::Types::CMerkleTx& txIn) : Legacy::Types::CMerkleTx(txIn), transactionWallet(walletIn), fHaveWallet(true)
            {
                InitWalletTx();
            }
             ...
             *
             **/
            CWalletTx(const CWallet& walletIn, const Legacy::Types::CTransaction& txIn) : Legacy::Types::CMerkleTx(txIn), transactionWallet(walletIn), fHaveWallet(true)
            {
                InitWalletTx();
            }
