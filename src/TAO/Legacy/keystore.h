...
namespace Wallet
{
    ...
    typedef std::map<uint256, CScript > ScriptMap;
    ...
    public:
        ...
        virtual bool HaveCScript(const uint256 &hash) const;
        virtual bool GetCScript(const uint256 &hash, CScript& redeemScriptOut) const;
    };
