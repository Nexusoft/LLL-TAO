...
namespace Wallet
{
    ...
    public:
        bool ReadTxIndex(uint512_t hash, Core::CTxIndex& txindex);
        bool UpdateTxIndex(uint512_t hash, const Core::CTxIndex& txindex);
        ...
        bool ReadOwnerTxes(uint512_t hash, int nHeight, std::vector<Core::CTransaction>& vtx);
        bool ReadDiskTx(uint512_t hash, Core::CTransaction& tx, Core::CTxIndex& txindex);
        bool ReadDiskTx(uint512_t hash, Core::CTransaction& tx);
