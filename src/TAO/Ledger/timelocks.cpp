...
namespace TAO
{
    ...
    namespace Ledger
    {
        ...
        const uint32_t TESTNET_BLOCK_VERSION_TIMELOCK[]   =
        {
            ...
            1582913471         //--- Block Version 8 Testnet Activation:  02/28/2020 11:11:11 GMT - 7
        };
        ...
        const uint32_t NETWORK_BLOCK_VERSION_TIMELOCK[]   =
        {
            ...
            1583950260         //--- Block Version 8 Activation:          03/11/2020 11:11:00 GMT - 7
        };
        ...
        const uint32_t TESTNET_TRANSACTION_VERSION_TIMELOCK[]   =
        {
            ...
            1582913471         //--- Transaction Version 2 Testnet Activation:  02/28/2020 11:11:11 GMT - 7
        };
        ...
        const uint32_t NETWORK_TRANSACTION_VERSION_TIMELOCK[]   =
        {
            ...
            1583950260         //--- Transaction Version 2 Activation:      03/11/2020 11:11:00 GMT - 7
        };
