...
namespace TAO
{
    ...
    namespace Operation
    {
        ...
        namespace Credit
        {
             ...
             *  @param[in] debit The contract that is holds the debit.
             *  @param[in] credit The contract that holds the credit
             ...
             *
             **/
            bool Commit(const TAO::Register::Object& account, const Contract& debit, const Contract& credit,
