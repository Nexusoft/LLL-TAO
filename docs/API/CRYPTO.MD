...
This method can be used to encrypt arbitrary data using the AES256 encryption function and a symmetric key.  This method supports three options for providing the symmetric key:
