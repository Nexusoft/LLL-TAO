...
`json` : If format is `JSON`, then this field will hold the json definition of the asset as a list of JSON objects representing each field in the object. It uses the following format:
