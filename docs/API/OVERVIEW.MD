...
| -177 | Invalid digits amount.  Digits must be whole number value between 0 and 8 |
| -178 | Invalid supply / digits.  The maximum combination of supply and digits (supply * 10^digits) cannot exceed 18446744073709551615 |
