...
| -18 | Missing data |
| -19 | Non-string types not supported in basic format |
...
| -50 | Missing txid |
| -51 | Debit transacton is not for a NXS account.  Please use the tokens API for crediting token accounts |
...
| -118 | Missing type |
| -119 | Missing supply |
| -120 | Debit transacton is for a NXS account.  Please use the Finance API for crediting NXS accounts |
