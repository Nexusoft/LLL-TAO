...
`pending` : The sum of all debit transactions made to your NXS accounts that are confirmed but have not yet been credited.  This does NOT include immature unconfirmed amounts
