...
`name_to` : The name identifying the token account to send to. This is optional if the address is provided.  The name can either be a local name or a namespaced name in the format name@namespace.  If a local name is used then the caller must be logged in (single user mode) or the the `session` parameter must be provided (multiuser mode).
...
`name` : The name identifying the token to list transactions for. This is optional if the address is provided. The name can either be a local name or a namespaced name in the format name@namespace.  If a local name is used then the caller must be logged in (single user mode) or the the `session` parameter must be provided (multiuser mode).
...
```
{
    ...
    "session": "16953804956473956578",
    "name": "savings",
    "token": "5efc8a9437d93e894defd50f8ba73a0b2b5529cc593d5e4a7ea413022a9c35e9"
}
```
...
`name` : The name identifying the token account to retrieve. This is optional if the address is provided.  The name can either be a local name or a namespaced name in the format name@namespace.  If a local name is used then the caller must be logged in (single user mode) or the the `session` parameter must be provided (multiuser mode).
...
`name` : The name identifying the token account to list transactions for. This is optional if the address is provided. The name can either be a local name or a namespaced name in the format name@namespace.  If a local name is used then the caller must be logged in (single user mode) or the the `session` parameter must be provided (multiuser mode).
