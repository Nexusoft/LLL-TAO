...
TEST_CASE( "Write Primitive Tests", "[operation]" )
{
    ...
    //test object register writes
    {
        ...
        object << std::string("byte") << uint8_t(TAO::Register::TYPES::MUTABLE) << uint8_t(TAO::Register::TYPES::UINT8_T) << uint8_t(55)
               ...
               << std::string("token_address") << uint8_t(TAO::Register::TYPES::UINT256_T) << uint256_t(0);
        ...
        REQUIRE(object.get<uint256_t>("token_address") == uint256_t(0));
        ...
        REQUIRE(object2.get<uint256_t>("token_address") == uint256_t(0));
        ...
        {
            Stream stream;
            stream << std::string("token_address") << uint8_t(OP::TYPES::UINT256_T) << uint256_t(99);
