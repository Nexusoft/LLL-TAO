 ...
 *   - ParsePayload: session_id parsed as little-endian, suffix returned as raw bytes
 *   - BuildUnifiedResponse: correct size (32 bytes), field positions, session_id LE, rest BE
 */
