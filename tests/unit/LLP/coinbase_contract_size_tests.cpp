 ...
 *  in handle_submit_block_stateless and handle_submit_block_stateless (miner.cpp) catches this
...
{
    const uint256_t hashGenesis = uint256_t("a174011c93calc80bca5deadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadb");
